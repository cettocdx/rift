...
export default defineConfig({
  testDir: ".",
  testMatch: "plugins.fixture.ts",
  outputDir: "./results/plugins",
  workers: 1,
  retries: 0,
  timeout: 30_000,
  reporter: [
    ...
    [
      "json",
      { outputFile: path.join(__dirname, "results/plugins/report.json") },
    ],
  ],
  use: {
  ...
  webServer: {
    command: "RIFT_PLUGINS_FIXTURE=1 node e2e/mobile-fixture/server.cjs",
    cwd: "../..",
