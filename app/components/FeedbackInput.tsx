      ...
      <div className="flex flex-col space-y-3">
        <div className="flex-1">
          <TextareaAutosize
            ...
            className="flex rounded-md border-input focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 overflow-hidden flex-1 bg-transparent p-2 border-0 w-full placeholder:text-[var(--cursor-text-tertiary)] text-base shadow-none resize-none min-h-[36px]"
            rows={2}
            maxRows={6}
            autoFocus
